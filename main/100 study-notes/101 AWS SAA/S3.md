...
> ---
> So if you IAM policy that allows S3 access but the *bucket policy* is **explicitly denying**you then you won’t be able to access the object.
